...
from czsc.strategies import CzscStocksBeta,CzscStocksV230329


dummy = czsc.DummyBacktest(strategy=CzscStocksV230329, read_bars=qmc.get_raw_bars, sdt='20200101', edt='20230301',
